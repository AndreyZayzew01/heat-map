...
test('renders percentages below 15 percent inline with the title', () => {
  ...
  assert.match(
    markup,
    /class="heatmap-cell-copy heatmap-cell-copy--compact"><span class="heatmap-cell-kicker">Наименование АС<\/span><span class="heatmap-cell-percent heatmap-cell-percent--inline">14\.00%<\/span><\/div>/,
  )
