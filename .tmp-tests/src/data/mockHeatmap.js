...
export function getHeatmapTone(value) {
    if (value >= 8) {
        return 'healthy';
    }
    if (value >= 5) {
...
const HEATMAP_TONE_COLOR_MAP = {
    critical: '#8f5260',
    warning: '#b69143',
    healthy: '#3ea86c',
};
export function getHeatmapToneColor(tone) {
...
export function normalizeHeatmapAssetPercents(items) {
    if (items.length === 0) {
        return [];
    }
