...
import { buildTreemapLayout } from '../data/mockHeatmap.js';
...
function TribeCard({ data, height }) {
    ...
    return (_jsxs("article", { className: "heatmap-card", children: [_jsx("header", { className: "heatmap-card-header", children: _jsx("h2", { children: TRIBE_TITLE }) }), _jsx("div", { className: "heatmap-grid", style: { height }, children: cells.map((cell) => {
                    ...
                    return (_jsx("div", { className: "heatmap-cell-slot", style: cellStyle, children: _jsxs("div", { className: `heatmap-cell heatmap-cell--${cell.tone}`, children: [_jsxs("div", { className: isCompactPercent
                                        ? shouldStackCompactPercent
                                            ? 'heatmap-cell-copy heatmap-cell-copy--compact-stack'
                                            : 'heatmap-cell-copy heatmap-cell-copy--compact'
                                        : 'heatmap-cell-copy', children: [_jsx("span", { className: "heatmap-cell-kicker", children: DASHBOARD_CELL_TITLE }), isCompactPercent ? (_jsxs("span", { className: shouldStackCompactPercent
                                                ? 'heatmap-cell-percent heatmap-cell-percent--stacked'
                                                : 'heatmap-cell-percent heatmap-cell-percent--inline', children: [cell.normalizedPercent.toFixed(2), "%"] })) : null] }), !isCompactPercent ? _jsxs("span", { className: "heatmap-cell-percent", children: [cell.normalizedPercent.toFixed(2), "%"] }) : null] }) }, cell.id));
                }) })] }));
}
function HeatMapPanel({ blocks }) {
    return (_jsx("div", { className: "heatmap-sections-row", children: blocks.map((block) => {
